...
raiz.iconbitmap("music.ico")
raiz.geometry("460x400")
raiz.resizable(0,0)


#crear Frame
framePrincipal = Frame(raiz, bg="#a0a0a0")
framePrincipal.pack(fill="both", expand=1)

#titulo reproductor
tituloreproductor = Label(framePrincipal, text="Reproductor MP3 - Exitos 2023", font=("Roboto", 20, "bold"), bg="#a0a0a0", fg="white")
